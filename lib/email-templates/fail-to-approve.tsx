...
export const FailToApprovedEmail = ({ baseUrl }: { baseUrl: string }) => (
  <Html>
    <Head />
    <Preview>Booking Was Cancelled</Preview>
    <Body style={main}>
      <Container style={container}>
        <Heading style={h1}>Your Booking Was Cancelled</Heading>
        <Text>Hello, </Text>
        <Text>
          We regret to inform you that your booking was cancelled due to admin&apos;s failed to approve or verify the booking.
        </Text>
        <Text>
...
export default FailToApprovedEmail;
